...
<div class="max-w-4xl mx-auto animate-fade-in">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-3xl border-t-4 border-yellow-600">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 mb-6 flex items-center border-b-2 border-yellow-100 pb-3">
            <i class="fas fa-plus-square text-yellow-600 mr-3"></i> Tambah Data Prestasi
        </h1>
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 border border-gray-100 rounded-xl bg-gray-50 shadow-inner">
                    ...
                    <div class="field-group">
                        ...
                        <input type="date" name="tanggal_dicapai" id="tanggal_dicapai" value="{{ old('tanggal_dicapai') ?? now()->format('Y-m-d') }}" required
                               class="block w-full border-2 border-gray-200 rounded-xl shadow-md p-3 transition duration-300 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 hover:border-indigo-400">
                    ...
                    <div class="field-group">
                        <label for="bukti_foto" class="block text-sm font-bold text-gray-700 mb-2 flex items-center">
                            <i class="fas fa-image mr-2 text-green-500"></i> Foto Utama (Thumbnail) <span class="text-red-500 ml-1">*</span>
                        </label>
                ...
                <div class="field-group p-4 border border-gray-100 rounded-xl bg-gray-50 shadow-inner">
                    <label for="dokumentasi" class="block text-sm font-bold text-gray-700 mb-2 flex items-center">
                        <i class="fas fa-paperclip mr-2 text-teal-600"></i> Dokumentasi Tambahan (Opsional)
                    </label>
